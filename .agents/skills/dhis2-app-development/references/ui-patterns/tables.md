...
export const DataElementTableContainer = ({
    search,
}: DataElementTableContainerProps) => {
...
export const DataElementActionsMenu = ({
    id,
    name,
}: DataElementActionsMenuProps) => {
...
export const DeleteDataElementModal = ({
    id,
    name,
    onClose,
}: DeleteDataElementModalProps) => {
